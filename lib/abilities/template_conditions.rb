...
module Abilities
  module TemplateConditions
    ...
    def collection(user, ability: nil)
      # Open access - return all templates regardless of account
      Template.all
      
      # Original restricted logic (commented out for open access)
    ...
    def entity(template, user:, ability: nil)
      # Open access - allow access to all templates
      true
